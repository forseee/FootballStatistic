...
export const setOneTeam = (teamInfo) => ({ type: SET_ONE_TEAM_STATISTIC, teamInfo });

export const setOneTeamDatetoDate = (teamInfoDatetoDate) => ({ type: FILTER_DATE_TEAM_STATISTIC, teamInfoDatetoDate });
